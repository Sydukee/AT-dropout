...
from network.lsoftmax import LSoftmaxLinear
import config

device = torch.device('cuda:{}'.format(config.args.gpu))
def create_network():
    return resnet20()
...
class ResNet(nn.Module):
    def __init__(self, block, n_size, num_classes=10):
        ...
        self.fc = LSoftmaxLinear(16, num_classes, margin=1, device=device)
